...
export default function AudioRecord () {
    ...
    return(
        ...
        {console.log(mediaRecorder)}
            <button id="start-record" onClick = {startRecord}>Start Recording</button>
            <button id="stop-record" onClick = {stopRecord}>Stop Recording</button>
            ...
            <audio src={sourcePlay} id="play" className = "audio-controls" controls></audio>
        </div>
